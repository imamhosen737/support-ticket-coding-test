...
(function (e, t) {
    ...
    function e(e) {
        ...
        return (
            (t.prototype = l(Object.create(e.prototype), { constructor: t })),
    ...
    function t() {
        var e = Ee.innerParams.get(this),
            t = Ee.domCache.get(this);
        e.showConfirmButton ||
            (q(t.confirmButton), !e.showCancelButton && q(t.actions)),
            T([t.popup, t.actions], B.loading),
    ...
    function n(e) {
        ...
        var t,
            ...
            o =
                "string" == typeof e.target
                    ? document.querySelector(e.target)
                    : e.target;
        (t = n && o && n.parentNode !== o.parentNode ? ie(e) : n || ie(e)),
            e.width &&
                (t.style.width =
        ...
        "function" == typeof e.animation && (e.animation = e.animation.call()),
            e.showCloseButton
                ? (m.setAttribute("aria-label", e.closeButtonAriaLabel), V(m))
                : q(m),
            (t.className = B.popup),
            e.toast
                ? (O(
                  ...
                  O(t, B.toast))
                : O(t, B.modal),
            e.customClass && O(t, e.customClass);
        var y = Q(),
            v = parseInt(
        ...
        e.progressSteps && e.progressSteps.length
            ? (V(y),
              ...
              e.progressSteps.forEach(function (t, n) {
                  ...
                  if (
                      (O(o, B.progresscircle),
                      (o.innerHTML = t),
                      n === v && O(o, B.activeprogressstep),
                      y.appendChild(o),
        ...
        if (
            (e.imageUrl
                ? (S.setAttribute("src", e.imageUrl),
                  ...
                  (S.className = B.image),
                  e.imageClass && O(S, e.imageClass))
                : q(S),
            e.showCancelButton ? (p.style.display = "inline-block") : q(p),
            e.showConfirmButton ? R(c, "display") : q(c),
            e.showConfirmButton || e.showCancelButton ? V(u) : q(u),
            ...
            (c.className = B.confirm),
            O(c, e.confirmButtonClass),
            (p.className = B.cancel),
            O(p, e.cancelButtonClass),
            e.buttonsStyling)
        ) {
            O([c, p], B.styled),
        ...
        ae(e.footer, g),
            !0 === e.animation ? T(t, B.noanimation) : O(t, B.noanimation),
    ...
    function o() {
        if ("undefined" != typeof window) {
            ...
            if ("undefined" == typeof t[0])
                return b("SweetAlert2 expects at least 1 attribute!"), !1;
            i = this;
    ...
    var i,
        ...
        E = { previousActiveElement: null, previousBodyPadding: null },
        S = function (e, t) {
        ...
        V = function (e) {
            (e.style.opacity = ""),
                (e.style.display = e.id === B.content ? "block" : "flex");
        },
        q = function (e) {
        ...
        ie = function (e) {
            ...
            if (
                (t &&
                    ...
                    T(
                        [document.documentElement, document.body],
                        [B["no-backdrop"], B["has-input"], B["toast-shown"]]
                    )),
                ne())
            )
            ...
            var i = M(),
                ...
                r = _(a, B.input),
                s = _(a, B.file),
                l = a.querySelector("." + B.range + " input"),
                d = a.querySelector("." + B.range + " output"),
                u = _(a, B.select),
                c = a.querySelector("." + B.checkbox + " input"),
                p = _(a, B.textarea);
        ...
        de = function () {
            null !== E.previousBodyPadding &&
                ((document.body.style.paddingRight = E.previousBodyPadding),
        ...
        ue = function () {
            ...
            if (e && !S(document.body, B.iosfix)) {
                ...
                (document.body.style.top = -1 * t + "px"),
                    O(document.body, B.iosfix);
            }
        },
        ce = function () {
            if (S(document.body, B.iosfix)) {
                var e = parseInt(document.body.style.top, 10);
                T(document.body, B.iosfix),
        ...
        me = function (e, t) {
            ...
            if (o) {
                null !== e && "function" == typeof e && e(o),
                    ...
                    te() ||
                        (I(),
                        (window.onkeydown = pe.previousWindowKeyDown),
                        (pe.windowOnkeydownOverridden = !1));
                var i = function () {
                ...
                re && !S(o, B.noanimation)
                    ? o.addEventListener(re, function e() {
        ...
        Pe = function (e, t, n) {
            ...
            null !== t && "function" == typeof t && t(i),
                e ? (O(i, B.show), O(o, B.fade), T(i, B.hide)) : T(i, B.fade),
                V(i),
                (o.style.overflowY = "hidden"),
                re && !S(i, B.noanimation)
                    ? i.addEventListener(re, function e() {
                          i.removeEventListener(re, e),
                              (o.style.overflowY = "auto");
                      })
                    : (o.style.overflowY = "auto"),
                O([document.documentElement, document.body, o], B.shown),
                ee() && (le(), ue()),
        ...
        Le = Object.freeze({
            ...
            getInput: function (e) {
                var t = Ee.innerParams.get(this),
                    n = Ee.domCache.get(this);
                return ((e = e || t.input), !e)
                    ? null
                    : "select" === e || "textarea" === e || "file" === e
                    ? _(n.content, B[e])
                    : "checkbox" === e
                    ? n.popup.querySelector("." + B.checkbox + " input")
                    : "radio" === e
                    ? n.popup.querySelector("." + B.radio + " input:checked") ||
                      n.popup.querySelector(
                          "." + B.radio + " input:first-child"
                      )
                    : "range" === e
                    ? n.popup.querySelector("." + B.range + " input")
                    : _(n.content, B.input);
            },
            ...
            showValidationError: function (e) {
                ...
                o &&
                    ...
                    o.setAttribute("aria-describedBy", B.validationerror),
                    P(o),
                    O(o, B.inputerror));
            },
            ...
            _main: function (e) {
                ...
                return new Promise(function (e, n) {
                    var l = function (t) {
                            s.closePopup(o.onClose, o.onAfterClose),
                    ...
                    for (
                        var m = function (e) {
                                if (
                                    (o.showLoaderOnConfirm && s.showLoading(),
                                    o.preConfirm)
                                ) {
                            ...
                            h = r.popup.querySelectorAll("button"),
                            y = 0;
                        y < h.length;
                        y++
                    )
                            ...
                            (r.container.onclick = function (t) {
                                return i
                                    ...
                                    : void (
                                          ...
                                          (w(o.allowOutsideClick) &&
                                              d(s.DismissReason.backdrop))
                                      );
                            });
                    }
                    o.reverseButtons
                    ...
                    o.toast &&
                        pe.windowOnkeydownOverridden &&
                        ((window.onkeydown = pe.previousWindowKeyDown),
                        (pe.windowOnkeydownOverridden = !1)),
                        o.toast ||
                            pe.windowOnkeydownOverridden ||
                            ((pe.previousWindowKeyDown = window.onkeydown),
                            (pe.windowOnkeydownOverridden = !0),
                            (window.onkeydown = function (n) {
                                ...
                                if ("Enter" === i.key && !i.isComposing) {
                                    ...
                                    [
                                        ...
                                        ? ("Escape" === i.key ||
                                              "Esc" === i.key) &&
                                          !0 === w(o.allowEscapeKey) &&
                                          d(s.DismissReason.esc)
                        ...
                        t.hideLoading(),
                        t.resetValidationError(),
                        o.input && O(document.body, B["has-input"]);
                    for (
                        var x = [
                                "input",
                                "file",
                        ...
                        if (((k = t.getInput(x[A])), k)) {
                            for (var L in k.attributes)
                                if (k.attributes.hasOwnProperty(L)) {
                            ...
                            for (var j in o.inputAttributes)
                                k.setAttribute(j, o.inputAttributes[j]);
                        }
                        (S.className = E),
                            o.inputClass && O(S, o.inputClass),
                            q(S);
                    }
                    var R;
                    switch (o.input) {
                        ...
                        case "tel":
                        case "url":
                            (k = _(r.content, B.input)),
                                (k.value = o.inputValue),
                                (k.placeholder = o.inputPlaceholder),
                                (k.type = o.input),
                                V(k);
                            break;
                        case "file":
                            (k = _(r.content, B.file)),
                                (k.placeholder = o.inputPlaceholder),
                                (k.type = o.input),
                                V(k);
                            break;
                        case "range":
                            var I = _(r.content, B.range),
                        ...
                        case "textarea":
                            ...
                            (Y.value = o.inputValue),
                                (Y.placeholder = o.inputPlaceholder),
                                V(Y);
                            break;
                        case null:
                            break;
                    ...
                    Pe(o.animation, o.onBeforeOpen, o.onOpen),
                        o.toast ||
                            (w(o.allowEnterKey)
